...
// Initialisez une variable pour le message de remerciement
$message = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Définir le message de remerciement
...
<body>
<div class="banner">
    <img src="waw.jpg" alt="Logo de l'entreprise">
</div>
...
<div class="alert alert-danger" style="background-color: #f8d7da; color: #721c24; border-color: #f5c6cb; padding: .75rem 1.25rem; margin-bottom: 1rem; border: 1px solid transparent; border-radius: .25rem; display: none;">
...
<script>
    ...
    form.addEventListener('submit', function(event) {
        ...
        // Envoyer les données du formulaire en utilisant fetch ou XMLHttpRequest
        fetch(form.action, {
            method: form.method,
        ...
        .then(data => {
            // Si la réponse est 'success', afficher la notification
            if (data === 'success') {
                Swal.fire({
                    title: 'Merci !',
                ...
                form.reset(); // Réinitialiser le formulaire après la soumission réussie
            } else {
                // Sinon, afficher la section des erreurs
